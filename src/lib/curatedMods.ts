...
export const curatedMods: CuratedMod[] = [
  ...
  { slug: "sodium", title: "Sodium", description: "High-performance rendering engine replacement for Minecraft. Dramatically improves frame rates and reduces micro-stutter.", category: "Optimization", image: "/assets/mods/sodium.webp" },
  ...
  { slug: "wthit", title: "WTHIT", description: "What The Helmet It Does - Shows what block/entity you're looking at. Essential for any modded playthrough.", category: "Utility", image: "/assets/mods/wthit.webp" },
