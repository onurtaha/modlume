...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    return { title: "Shader Not Found - ModLume" };
  }
}
                ...
                <div className="flex flex-col md:flex-row md:items-end gap-4 md:gap-8">
                  ...
                  <div className="flex items-end gap-4 flex-1">
                    ...
                    <div>
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge variant="outline" className="text-xs bg-primary/20 border-primary/50 text-primary">SHADER</Badge>
                      </div>
                      {team.length > 0 && (
                  ...
                  <div className="shrink-0">
                    <a href={`/api/download/${project.slug || project.id}`} className="download-btn inline-flex">
                      ...
                      <span>Download Shader</span>
                      <span className="hidden md:inline text-sm opacity-80 ml-2">• Minecraft 1.21.11 OptiFine/Iris</span>
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
                {project.icon_url ? (
                  <div className="relative shrink-0">
                    ...
                    <Badge variant="outline" className="absolute -bottom-2 -right-2 text-xs bg-primary/20 border-primary/50 text-primary">SHADER</Badge>
                  </div>
                ) : (
                ...
                <div className="shrink-0 lg:w-72">
                  <a href={`/api/download/${project.slug || project.id}`} className="download-btn inline-flex">
                    <Download className="h-5 w-5" />
                    <span>Download Shader</span>
                    <span className="hidden md:inline text-sm opacity-80 ml-2">• Minecraft 1.21.11</span>
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-8">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs text-muted-foreground">
              ...
              <span className="hidden md:inline">→</span>
              <span>3. Video Settings &gt; Shaders</span>
              <span className="hidden md:inline">→</span>
              <span>4. Put file in shaders folder</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section>
              ...
              <div className="rounded-xl border border-border bg-card p-5">
                ...
                {project.body.length > 800 && (
                  <a
                    href={`https://modrinth.com/shader/${project.slug}`}
                    target="_blank"
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <p className="text-xs text-muted-foreground">Required Mods</p>
                  <p className="font-medium">OptiFine / Iris</p>
                </div>
                {project.license && (
                  <div>
        ...
        {related.length > 0 && (
          <section className="mt-12">
            <h2 className="mb-6 text-xl font-semibold">Related Shaders</h2>
